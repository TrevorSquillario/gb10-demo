...
def accelerate_with_tensorrt(
    ...
    # For SDXL the UNet encoder_hidden_states is the concat of both CLIPs
    # (768 + 1280 = 2048) and requires added_cond_kwargs in every call.
    _is_sdxl = stream.sdxl
    if _is_sdxl and hasattr(stream.pipe, "text_encoder_2"):
        _embed_dim = (
        ...
        _embed_dim = text_encoder.config.hidden_size
        _pooled_dim = 1280
